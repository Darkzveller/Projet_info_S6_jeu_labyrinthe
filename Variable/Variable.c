...
char *type_partie_choisi[4] = {"TRAINING DONTMOVE display=debug timeout=10000 seed=1 start=0", "TRAINING RANDOM timeout=10000 seed=0 start=0", "TRAINING BASIC timeout=100 display=debug seed=0 start=0", 0};
