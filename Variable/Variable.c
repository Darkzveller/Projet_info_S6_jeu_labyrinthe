...
char *nom_bot_moi = "cacaboudinV7";

// Information du labyrinthe
char *type_partie_choisi[4] = {"TRAINING DONTMOVE display=debug timeout=10000 seed=1 start=0", "TRAINING RANDOM timeout=10000 seed=0 start=0", "TRAINING BASIC timeout=10000 seed=0 start=0", 0};
